    ...
    public class Worker : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            try
            {
                ...
                DateTime fromDate = new(2022, 1, 1);
                ...
                var chartPrices = await _chartPriceData.CacheFindAllAsync("VNINDEX", "D") ?? throw new Exception("indexChartPrices is null");
                ...
                Console.Clear();
                Console.Clear();
                var trader = new SmaPSarTrading(chartPrices);
                ...
                Console.WriteLine();
                Console.WriteLine($"kết quả {nameof(SmaPSarTrading)} {symbol} trong {chartTrading.Count} phiên có {tradingCase.NumberDayInStock} phiên giữ cổ phiếu, {tradingCase.NumberDayInMoney} phiên giữ tiền");
