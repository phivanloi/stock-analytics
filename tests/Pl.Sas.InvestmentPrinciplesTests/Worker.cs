    ...
    public class Worker : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            try
            {
                ...
                Console.Clear();
                Console.Clear();
                var trader = new IndexSmaPSarTrading(chartPrices, indexChartPrices);
                ...
                Console.WriteLine();
                Console.WriteLine($"kết quả {nameof(IndexSmaPSarTrading)} {symbol} trong {chartTrading.Count} phiên có {tradingCase.NumberDayInStock} phiên giữ cổ phiếu, {tradingCase.NumberDayInMoney} phiên giữ tiền");
