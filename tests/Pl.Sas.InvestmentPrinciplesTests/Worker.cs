    ...
    public class Worker : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            try
            {
                ...
                Console.Clear();
                Console.Clear();
                var trader = new StochRsiTrading(chartPrices, indexChartPrices);
                ...
                Console.WriteLine();
                Console.WriteLine($"kết quả {nameof(StochRsiTrading)} {symbol} trong {chartTrading.Count} phiên có {tradingCase.NumberDayInStock} phiên giữ cổ phiếu, {tradingCase.NumberDayInMoney} phiên giữ tiền");
