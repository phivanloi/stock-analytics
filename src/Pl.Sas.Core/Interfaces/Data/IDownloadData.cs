...
namespace Pl.Sas.Core.Interfaces
{
    ...
    public interface IDownloadData
    {
        ...
        /// <param name="type">mặc định là chart ngày</param>
        /// <returns>VndChartPrice</returns>
        Task<VndChartPrice?> DownloadVndChartPricesRealTimeAsync(string symbol, string type = "D");

        /// <summary>
        /// Tải dữ liệu chart realtime của ssi
        /// </summary>
        /// <param name="symbol">Mã chứng khoán</param>
        /// <param name="type">mặc định là chart ngày</param>
        /// <returns>SsiChartPrice</returns>
        Task<SsiChartPrice?> DownloadSsiChartPricesRealTimeAsync(string symbol, string type = "D");
        ...
        /// </summary>
        /// <returns></returns>
        Task<List<MarketDepth>> DownloadMarketInDepthAsync();
